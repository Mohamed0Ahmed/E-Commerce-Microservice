...
internal class InitialData
{
    ...
    [
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Mohamed", "mohamed@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Kareem", "kareem@gmail.com")
    ];
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Mohamed", "Ahmed", "mohamed@gmail.com", "Damietta No:4", "Egypt", "Damietta", "38050");
            var address2 = Address.Of("Kareem", "Ahmed", "kareem@gmail.com", "Madint Nasr No:1", "Egypt", "Cairo", "08050");

            var payment1 = Payment.Of("Mohamed", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("Kareem", "8885555555554444", "06/30", "222", 2);
